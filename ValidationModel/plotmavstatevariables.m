...
% modified 12/11/2009 - RB
    ...
    Va_hat      = uu(37);            % estimated airspeed (meters/s)
    alpha_hat   = 180/pi*uu(38);     % estimated angle of attack (degrees)
    beta_hat    = 180/pi*uu(39);     % estimated side slip angle (degrees)
    phi_hat     = 180/pi*uu(40);     % estimated roll angle (degrees)   
    theta_hat   = 180/pi*uu(41);     % estimated pitch angle (degrees)
    chi_hat     = 180/pi*uu(42);     % estimated course (degrees)
    p_hat       = 180/pi*uu(43);     % estimated body angular rate along x-axis (degrees/s)
    q_hat       = 180/pi*uu(44);     % estimated body angular rate along y-axis (degrees/s)
    r_hat       = 180/pi*uu(45);     % estimated body angular rate along z-axis (degrees/s)
%    Vg_hat      = uu(46);            % estimated groundspeed
%    wn_hat      = uu(47);            % estimated North wind
%    we_hat      = uu(48);            % estimated East wind
%    psi_hat     = 180/pi*uu(49);     % estimated heading
%    bx_hat      = uu(50);            % estimated x-gyro bias
%    by_hat      = uu(51);            % estimated y-gyro bias
%    bz_hat      = uu(52);            % estimated z-gyro bias
